...
def test_risk_flags_risk_off_and_on() -> None:
    ...
    rows = {
        "vix": SeriesRow(id="vix", category="risk_assets", last=20.0, deltas={"d1": None, "d5": 1.0, "d21": None}),
        "sp500": SeriesRow(id="sp500", category="risk_assets", last=5000.0, deltas={"d1": None, "d5": -10.0, "d21": None}),
    }
